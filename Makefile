...
# Additional proto include directory for google/api/annotations.proto
ADDITIONAL_PROTOINCLUDE ?= ../googleapis
...
FLAGS+= --proto_path=/usr/local/include:$(PROTOINCLUDE):$(ADDITIONAL_PROTOINCLUDE)
